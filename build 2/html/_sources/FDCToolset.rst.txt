...
Now that you are logged in and have an active ticket, you can view the feature data in the 811 Ticket. Hover over the icons in the toolset to see your options.

.. figure:: /_static/D-TicketMap.png
   :alt: FDC Ticket Map
   :class: with-border
...
Edit Features
^^^^^^^^^^^^^^
To add new information for this ticket, select the **Edit Features** or pencil icon from the toolset. FDC automatically captures your location, but you can toggle **Hide Current Location** if you are not at the dig site. Define the information needed to capture a new feature:

* **Geometry Type** you want to add: a point, a polygon, or a line. 
* A **Lable** that will identify this feature in the future.
* **Notes** to describe the feature you are adding.

.. figure:: /_static/D-EditFeatures1.png
   :alt: Add a new feature
   :class: with-border
...
Draw Feature
^^^^^^^^^^^^^^
Once you click the **Draw Feature** button you are in the drawing mode. Click at the site of the feature. 
...
.. figure:: /_static/D-DocManager.png
